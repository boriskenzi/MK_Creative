...
export const tarifFamilies = [
    ...
    groups: [
      {
        ...
        packs: [
          ...
          },
          {
            ...
            price: "200 000 FCFA",
            hours: "Jusqu’à la réception",
            summary: "Photos illimitées, album 100 photos, vidéo",
            items: ["Photos illimitées", "Album 100 photos", "Vidéo", "Fin de service à la réception"],
          },
          {
            name: "Formule Avancée",
            price: "250 000 FCFA",
            hours: "Jusqu’à 19h, extensible",
            summary: "Album, vidéo résumé, vidéo longue, tableau 42×30",
            items: [
              "Photos illimitées",
              "Album 100 photos",
              "1 vidéo résumé",
              "1 vidéo longue",
              "Tableau photo 42 × 30 cm",
            ],
          },
          {
            name: "Formule Avancée +",
            ...
            badge: "Recommandée",
            hours: "Jusqu’à 19h, extensible",
            summary: "Album, deux vidéos, clé USB et cadre photo",
            items: [
              "Photos illimitées",
              "Album + 100 photos",
              "1 vidéo résumé",
          ...
          },
          {
            ...
            price: "375 000 FCFA",
            hours: "Jusqu’à 21h",
            summary: "Prise de vue aérienne, tableau 42×30",
            items: [
              "Photos illimitées",
              "Album + 100 photos",
              "Vidéo résumé",
          ...
          },
          {
            ...
            price: "550 000 FCFA",
            hours: "Sans heure limite",
            summary: "Prestige : pre-wedding, aérien, album 200 photos",
            items: [
              "Photos illimitées retouchées sur clé USB",
              "Album + 200 photos",
              "Pas d’heure limite",
              "1 shooting pre-wedding avec vidéo d’annonce ou EVJF",
              "Vidéo résumé pour les réseaux",
              "Vidéo complète",
              "Prise aérienne",
              "Tableau 60 × 32 cm",
            ],
  ...
  },
  {
    ...
    groups: [
      ...
      },
      {
        ...
        note: "Planning de publication à transmettre avant production. Textes, photos et logos fournis par le client.",
        packs: [
          {
            name: "À l’unité",
            price: "À partir de 10 000 FCFA",
          ...
          },
          {
            ...
            price: "170 000 FCFA / mois",
            summary: "16 visuels • 3 séries de modifications",
            items: ["16 visuels sur-mesure", "3 séries de modifications par visuel"],
          },
          {
            name: "Formule Premium",
            price: "215 000 FCFA / mois",
            summary: "20 visuels • 3 séries de modifications",
            items: ["20 visuels sur-mesure", "3 séries de modifications par visuel"],
          },
          {
            name: "Formule Intensive",
            price: "215 000 FCFA / mois",
            summary: "25 visuels • 3 séries de modifications",
            items: ["25 visuels sur-mesure", "3 séries de modifications par visuel"],
          },
        ],
      },
    ],
  },
  {
    ...
    groups: [
        ...
        packs: [
          {
            name: "Format court",
            price: "À partir de 25 000 FCFA",
            summary: "15 secondes, voix off et sous-titres",
            items: ["15 secondes", "Animation d’images", "Voix off IA", "Sous-titres animés"],
          },
          {
            name: "Format standard",
            price: "À partir de 40 000 FCFA",
            summary: "30 secondes, transitions et sound design",
            items: ["30 secondes", "Scénarisation courte", "Transitions IA", "Voix off et sound design"],
          },
          {
            name: "Format développé",
            price: "À partir de 70 000 FCFA",
            summary: "1 minute, multi-scènes, habillage sonore",
            items: ["60 secondes", "Animation multi-scènes", "Voix off pro IA", "Habillage sonore"],
          },
          {
            name: "Format long",
            price: "Sur devis",
      ...
      {
        id: "ai-spot",
        title: "Spots publicitaires IA",
        packs: [
          {
            name: "Spot Flash",
            price: "À partir de 15 000 FCFA",
            summary: "15 à 30 s • 3 à 5 scènes",
            items: ["Script publicitaire", "3 à 5 scènes IA", "Voix off professionnelle", "Sound design"],
          },
          {
            name: "Spot Master",
            price: "À partir de 50 000 FCFA",
            summary: "60 s • 8 à 12 scènes, logo animé",
            items: [
              "Script complet",
              "8 à 12 scènes IA",
              "Montage dynamique",
              "Voix off",
              "Animation de logo et texte",
            ],
          },
        ],
      },
